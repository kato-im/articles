...
* To contribute a translation:
  1. Copy the file structure of articles in [`/en`](https://github.com/kato-im/articles/tree/master/en).
  2. Adjust the [`util/manifest.json`](https://github.com/kato-im/articles/blob/master/util/manifest.json) with your changes.
