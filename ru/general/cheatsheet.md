...
Администраторы команд в Kato могут активировать функцию совершения **видеозвонков**, которая включает в себя **голосовые вызовы** и возможность **демонстрации экрана**. Для этого необходимо активировать соответствующую в [настройках команды](https://app.kato.im/#/membership/) из меню **Kato Labs**.
...
Подробнее процесс редактирования сообщений описан в [соответствующей главе](https://kato.im/articles/ru/cheatsheet/edit-message) руководства.

********************************************************************************
## <a href="#message-cards" name="message-cards">Карточки сообщений</a>

При наведении курсора на сообщение, слева появится небольшая полоса, клик на которую открывает меню с **карточкой сообщения** (по аналогии с [карточкой пользователя](https://kato.im/articles/ru/cheatsheet/profile-cards) содержит информацию о сообщении).

![clip.png](https://in.kato.im/e766111232fe8e444c3a385f11b31cdd98e195314072f23c45013a497e568db/clip.png)

Эта карточка содержит информацию о времени отправки сообщения и несколько полезных команд — некоторые из них, к примеру, используются для [форматирования](https://kato.im/articles/ru/cheatsheet/#message-formatting). 

********************************************************************************
## <a href="#room-layout" name="room-layout">Шаблон комнат Kato</a>

Мессенджер Kato позволяет пользователям общаться с собеседниками (из одной или нескольких команд) сразу в нескольких беседах или «комнатах» — и все это в одном окне.
