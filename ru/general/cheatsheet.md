...
Для вставки в сообщение пустой строки необходимо нажать комбинацию клавиш **Shift+Return**:
...
Функциональность видео-звонка также включает возможность **демонстрации экрана**.
